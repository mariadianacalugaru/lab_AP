        ...
        <div className="multiple_cards">
          {nutritionists.map((item) => (
            <MDBCard className="nutritionist_card">
              <MDBCardImage className="picture" src='https://mdbootstrap.com/img/new/standard/nature/184.webp' position='top' alt='...' />
              <MDBCardBody className="card_text">
                <MDBCardTitle className="name">{item.firstname} {item.lastname}</MDBCardTitle>
